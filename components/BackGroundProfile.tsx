...
const BackGroundProfile = (props: Props) => {
	return (
		...
		>
			<div className=" absolute border border-[#43dde6] rounded-full h-[200px] w-[200px] mt-52 animate-ping" />
			...
			<div className=" rounded-full border border-[#fc5185] opacity-20 h-[640px] w-[650px] absolute mt-52  animate-pulse" />
